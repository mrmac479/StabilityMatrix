...
namespace StabilityMatrix.Avalonia.Workflows
{
    public class ImageTagger : BaseWorkflow
    {
        ...
        public static async Task<string> TagImages(ComfyOrchastrationViewModel image)
        {
        ...
        public static async Task<string> TagSegs(ComfyOrchastrationViewModel image)
        {
        ...
        internal static void CleanUp(ComfyOrchastrationViewModel image, CleanOptions option)
        {
